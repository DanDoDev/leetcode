            ...
            for(let k=0; k < 4; k++){
                ...
                switch(k){
                    case 0: 
                        ...
                        break;
                    case 1:
                        secondPositionInMemory = matrix[gridLength - 1 - i - j][gridLength - 1 - i - j];
                        console.log('move2', secondPositionInMemory, positionInMemory);
                        matrix[gridLength - 1 - i - j][gridLength - 1 - i - j] = positionInMemory;
                        break;
                    case 2:
                        ...
                        break;
                    case 3:
                        console.log('move4', matrix[0 + i + j][0 + i + j], positionInMemory);
                        matrix[0 + i + j][0 + i + j] = positionInMemory;
                        break;
                }
            }
        }
